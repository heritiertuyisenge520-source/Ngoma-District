  ...
  const menuItems = useMemo(() => {
    ...
    if (isSuperAdmin) {
      items.push(
        ...
        { id: 'indicator-formula', label: 'Indicator Formula', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg> },
    ...
    if (isHeadOfUnit) {
      items.push(
        ...
        { id: 'document-upload', label: 'Document Upload', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-2m0 0A4 4 0 017 12a4 4 0 018.12 0m0 0A4 4 0 0211 16a4 4 0 01-4.12 0m-.39-6.36A4 4 0 014.46 5.88M12 10a4 4 0 00-4.12 0m0 0A4 4 0 016.46 5.88M12 10A4 4 0 014.12 10m0 0A4 4 0 0112 14m0 0a4 4 0 014.12 0m0 0A4 4 0 0216.46 14m0 0A4.002 4.002 0 0014 12a4 4 0 00-4.12 0m0 0h6.36" /></svg> }
      );
    }
